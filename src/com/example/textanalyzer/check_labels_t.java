...
import com.example.check_labels_p.check_label.*;

/**
 * Created by Maxim.Rumyantsev on 15-Feb-18.
 *
 * Пришло время попробовать реализовать иерархию классов определенного вида и решить конкретную задачу.
 ...
 Последний штрих – написать метод checkLabels, который будет возвращать метку для комментария по набору анализаторов текста. checkLabels должен возвращать первую не-OK метку в
 порядке данного набора анализаторов, и OK, если все анализаторы вернули OK.
...
//        Main testObject = new Main();
        ...
        for (String test : tests) {
            ...
            for (TextAnalyzer[] analyzers : textAnalyzers) {
                System.out.print(numberOfAnalyzer + ": "+analyzers+": "+  test +": " );
